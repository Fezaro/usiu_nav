...
class Environment():
    # start = "76"
    # goal = "118"
    # Initialize graph of the school map-all paths accessible by foot and vehicle
    myGraph = {
    ...
    def display_places(self):
        """Display node to place mapping for user"""
        cprint("*" * 123, "magenta")
        print("*" * 123)
        print()
        cprint(f"{'Check the location mapping:': ^123}", "red")
        print()
        for k, v in Environment.location_dict.items():
            cprint(f"{v:_^60} : {k:_^60}", 'yellow')

    # Map Graph Cost in secs
    cost = {
        ...
        str(["156", "130"]): "67", str(["156", "73"]): "91", str(["156", "108"]): "123", str(["156", "68"]): "124",
        str(["156", "15"]): "123",
        str(["130", "10"]): "24", str(["130", "156"]): "67", str(["130", "73"]): "107", str(["130", "68"]): "75",
        str(["130", "108"]): "136", str(["130", "15"]): "123",
        ...
        str(["108", "130"]): "136", str(["108", "156"]): "123", str(["108", "10"]): "105 ", str(["108", "68"]): "80",
    ...
    vh_cost = {
        ...
        str(["119", "99"]): "17", str(["119", "112"]): "64", str(["119", "126"]): "178",str(["119", "127"]): "248",
        str(["127", "54"]): "382", str(["127", "118"]): "381", str(["127", "69"]): "95", str(["127", "119"]): "248",
        str(["126", "127"]): "108",str(["126", "119"]): "178",
        str(["76", "69"]): "98",
        str(["54", "127"]): "382", str(["54", "118"]): "117",
        str(["118", "54"]): "117", str(["118", "127"]): "381",
    }
    ...
    def getCar():
        """Generate heuristics based on time of day"""
        hour = []
        cars = []
        for i in range(24):
            hour.append(str(i))
...
class Agent(Environment):
    ...
    def Astar(graph, start, goal):
        """Route selection using A-star algo"""
        p = []
        p.append(start)
        while True:
            ngh = graph[start]
    ...
    def vh_ucs(graph, start, goal):
        """vehicle route selection using UCS algo"""
        stack = [(start, [start])]
        p = []
        least_cost = 5000
    ...
    def path(self, choice, Start, Goal):
        """route selection foot or vehicle"""
        ...
        if choice == "b" or choice == "B":
            ...
            print()
            print(f'{Agent.vh_ucs(Environment.carGraph, Start, Goal)}')
            cprint("-" * 123, "red")
    ...
    def __init__(self, Environment):
        ...
        cprint("*" * 123, "grey")
        cprint("*" * 123, "cyan")
        cprint(f"{'USIU-AFRICA UNIVERSITY MAP NAVIGATOR' : ^123}", "red")
